...
export interface AnalysisResult {
    mediaType: string;
    summary: string;
    frameworkAnalyses: Record<string, string>;
...
export class AnalysisEngine {
    ...
    async analyzeContent(content: string | TFile, mediaType: string, frameworks: string[]): Promise<AnalysisResult> {
        switch (mediaType) {
            case MEDIA_TYPES.TEXT:
                return this.analyzeText(content as string, frameworks);
    ...
    async analyzeText(content: string, frameworks: string[]): Promise<AnalysisResult> {
    ...
    async analyzeImage(file: TFile, frameworks: string[]): Promise<AnalysisResult> {
        const result: AnalysisResult = {
    ...
    async analyzeAudio(file: TFile, frameworks: string[]): Promise<AnalysisResult> {
        const result: AnalysisResult = {
    ...
    async analyzeFilm(file: TFile, frameworks: string[]): Promise<AnalysisResult> {
        const result: AnalysisResult = {
    ...
    generateFrameworkAnalysis(content: string, framework: string, mediaType: string): string {
    ...
    generateRecommendations(frameworkAnalyses: Record<string, string>): string[] {
